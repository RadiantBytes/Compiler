...
{
  "$end", "error", "$undefined", "Ident", "Int", "'='", "';'", "'+'",
  "'*'", "'-'", "'('", "')'", "$accept", "Prog", "StmtSeq", "Stmt", "Expr",
...
{
       0,   256,   257,   258,   259,    61,    59,    43,    42,    45,
      40,    41
};
# endif
...
{
       3,   -11,     5,   -11,     3,     7,   -11,   -11,    -2,   -11,
      -2,    -2,    -3,     6,   -11,   -11,   -11,     2,   -11,    -2,
      -2,   -11,     6,   -11
};
...
{
       4,    14,     0,     2,     4,     0,     1,     3,     0,    13,
       0,     0,     0,     7,     9,    12,    10,     0,     5,     0,
       0,    11,     6,     8
};
...
{
      16,     1,     9,    18,    19,     6,     1,    10,    11,    19,
      23,     5,     8,    21,    20,     5,     7,     0,    22,    17
};

static const yytype_int8 yycheck[] =
{
      10,     3,     4,     6,     7,     0,     3,     9,    10,     7,
      20,     0,     5,    11,     8,     4,     4,    -1,    19,    11
};
...
{
       0,     3,    13,    14,    15,    19,     0,    14,     5,     4,
       9,    10,    16,    17,    18,    19,    18,    16,     6,     7,
       8,    11,    17,    18
};
...
#line 60 "boolExpr.y" /* yacc.c:1906  */
